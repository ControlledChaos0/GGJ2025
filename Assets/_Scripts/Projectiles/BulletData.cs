...
public class BulletData : ScriptableObject
{
    ...
    [SerializeField] private float spriteScale = 1;
    public float SpriteScale { get => spriteScale; }
    [SerializeField] private float sizeRandomness = 0;
    public float SizeRandomness { get => sizeRandomness; }
    ...
    [SerializeField] private bool scaleKnockbackBySpeed = false;
    public bool ScaleKnockbackBySpeed { get => scaleKnockbackBySpeed; }
